      ...
      <ul class="sidebar-menu" data-widget="tree">  
		...
		<li class="treeview ">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('student.reg.view') }}"><i class="ti-more"></i>Employee Registration Year</a></li>
			<li><a href="{{ route('student.reg.view') }}"><i class="ti-more"></i>Teacher Registration</a></li>
          </ul>
